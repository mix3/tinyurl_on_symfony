...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/home/mix3/myproject/log/tinyurl_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/home/mix3/myproject/cache/tinyurl/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/mix3/myproject/apps/tinyurl/i18n',
));
  ...
  $class = sfConfig::get('sf_factory_routing', 'sfPatternRouting');
      $cache = new sfFileCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/mix3/myproject/cache/tinyurl/dev/config/routing',
  'lifetime' => 31556926,
  'prefix' => '/home/mix3/myproject/apps/tinyurl/routing',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/mix3/myproject/cache/tinyurl/dev/template',
  'lifetime' => 86400,
  'prefix' => '/home/mix3/myproject/apps/tinyurl/template',
)));
